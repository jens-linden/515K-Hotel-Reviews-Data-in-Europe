...
# Description   : Collection of helper functions - project independent
# 
# STEP 1        : Load re-usable CC-assets
...
# ================================================================================================x
# Description     : Pruning of tree corresponding to 1SE rule
# Input           : tree - RPART decision tree
#                   se_factor - Factor for standard deviation (usually 1)
# Output          : tree - Pruned tree
# Review status   : Final
# ================================================================================================x
auto_prune <- function(tree, se_factor=1) {
  cv_perf <- as.data.table(tree$cptable)
